---
id: profile
title: Everson Filipe — Systems Analyst & Implementation · Agentic AI
...
## Everson Filipe
**Systems Analyst & Implementation · Agentic AI**
*Bridging the gap between business requirements and scalable software execution through rigorous data validation and process automation.*
...
- **2025 Aspire Leaders Program**, Aspire Institute (Dec 2025)
- **Lab.AI: Preparing the Next Generation for the Future of Work**, Instituto Joule (Sep 2025)
- **Ignite Entrepreneurship Program**, Wadhwani Foundation (Jul 2025)
- **SkillsBuild - Customer Engagement: Problem Solving and Process Controls**, IBM (Jul 2025)
- **EF SET English Certificate 69/100 (C1 Advanced)**, EF Education First (Feb 2025)
- **Comunicación Intercultural - Proyecto Internacional**, Campus B (Oct 2024)
- **Cross-disciplinary Competency - Information and Communication Technology**, SENAI (Nov 2023)

### Articles & Technical Publications
#### Some trends do not stay as trends: the world is a fractal (Nov 2024)
- **Publisher/Platform**: Medium
...
#### Development of the Creative Economy in Northeastern Brazil (Dec 2024)
- **Publisher/Platform**: Medium
...
#### Alive Architecture: Redefining How We Build a Sustainable Future (Dec 2024)
- **Publisher/Platform**: Medium
...
#### Design your thinking: the art of being (Jan 2025)
- **Publisher/Platform**: Medium
- **URL**: https://medium.com/design-bootcamp/design-your-thinking-the-art-of-being-5b7e8b9ca3b7?sharedUserId=eversonfilipe

#### From Problem to Solution: A Framework for Building Value-Driven Products (Feb 2025)
- **Publisher/Platform**: Medium
...
#### Product Optimization: Too much UI can break your UX (Mar 2025)
- **Publisher/Platform**: Medium
...
#### Gestão Ágil Simplificada (Oct 2024)
