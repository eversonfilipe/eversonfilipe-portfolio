...
(function I18n() {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      'nav.experience.endorsements': 'Endorsements & Recommendations',
      'endorsements.overline': 'Social Proof & Peer Validation',
      'endorsements.title': 'Endorsements & Recommendations',
      'endorsements.subtitle': 'Testimonials, recognitions, and peer validations received across corporate environments, projects, and mentorships.',
      'endorsements.readMore': 'Read more',
      'endorsements.readLess': 'Read less',
      'endorsements.credential.btn': 'Show Credential / Proof',
      'endorsements.notice.text': 'Note: Authors\' titles capture a snapshot at the time of endorsement formatted as (CURRENT ROLE) | (ROLE AT CONTEXT OF RECOMMENDATION). For real-time career updates, visit their LinkedIn profiles.',
      ...
      'exp.about.company.btn': 'About the Company',
      'exp.about.company.close': 'Close company info',
      'exp.company_ticker.title': 'Featured Companies',
      'exp.company_modal.about': 'About the Company',
      'exp.company_modal.roles': 'Positions & Roles',
      'exp.company_modal.view': 'View Details',
      'exp.company_modal.close': 'Close modal',
      'edu.provider_ticker.title': 'Course Providers',
      'edu.provider_modal.credentials': 'Credential Links',
      'edu.provider_modal.all_courses': 'All courses from this provider',
      'edu.provider_modal.close': 'Close modal',
      'btn.expand': 'Expand',
      'btn.minimize': 'Minimize',
      'exp.card.expand': 'Expand details',
      'exp.card.collapse': 'Collapse details',
      ...
      'blog.overline': 'Writing',
      'blog.title': 'Blog',
      'blog.read.btn': 'Read',
      'blog.close.btn': 'Close article',
    ...
    pt: {
      ...
      'hero.cta.projects': 'Ver projetos principais',
      'hero.cta.contact': 'Entrar em contato',
      'hero.scroll': 'rolar',
      'about.overline': 'Sobre',
      'about.heading': 'Quem é Éverson Filipe',
      ...
      'edu.heading': 'Educação',
      'edu.courses.label': 'Cursos',
      'edu.publications.label': 'Artigos e Produções',
      'publication.view.btn': 'Visualizar',
      'nav.experience.endorsements': 'Recomendações & Endossos',
      'endorsements.overline': 'Prova Social & Validação de Pares',
      'endorsements.title': 'Recomendações & Endossos',
      'endorsements.subtitle': 'Depoimentos, reconhecimentos e avaliações recebidas em ambientes corporativos, projetos e mentorias.',
      'endorsements.readMore': 'Ver mais',
      'endorsements.readLess': 'Ver menos',
      'endorsements.credential.btn': 'Exibir Credencial / Comprovante',
      'endorsements.notice.text': 'Nota: Os cargos dos autores refletem uma fotografia no momento da recomendação no formato (CARGO ATUAL) | (CARGO NO CONTEXTO DA RECOMENDAÇÃO). Para atualizações em tempo real, consulte seus perfis no LinkedIn.',
      'community.overline': 'Comunidade e Impacto',
      'community.heading': 'Além do código',
      ...
      'projects.heading': 'Projetos Principais',
      ...
      'exp.about.company.btn': 'Sobre a Empresa',
      'exp.about.company.close': 'Fechar informações da empresa',
      'exp.company_ticker.title': 'Empresas em Destaque',
      'exp.company_modal.about': 'Sobre a Empresa',
      'exp.company_modal.roles': 'Cargos e Atuações',
      'exp.company_modal.view': 'Ver Detalhes',
      'exp.company_modal.close': 'Fechar modal',
      'edu.provider_ticker.title': 'Provedores de Cursos',
      'edu.provider_modal.credentials': 'Links de Credencial',
      'edu.provider_modal.all_courses': 'Todos os cursos deste provedor',
      'edu.provider_modal.close': 'Fechar modal',
      'btn.expand': 'Expandir',
      'btn.minimize': 'Minimizar',
      'exp.card.expand': 'Ver detalhes',
      'exp.card.collapse': 'Recolher detalhes',
      ...
      'blog.overline': 'Escrita',
      'blog.title': 'Blog',
      'blog.read.btn': 'Ler',
      'blog.close.btn': 'Fechar artigo',
      'blog.published': 'Publicado em',
      'blog.share.btn': 'Copiar link',
    ...
    es: {
      ...
      'hero.cta.projects': 'Ver proyectos principales',
      ...
      'publication.view.btn': 'Visualizar',
      'nav.experience.endorsements': 'Recomendaciones & Avales',
      'endorsements.overline': 'Prueba Social y Validación de Pares',
      'endorsements.title': 'Recomendaciones & Avales',
      'endorsements.subtitle': 'Testimonios, reconocimientos y validaciones recibidas en entornos corporativos, proyectos y mentorías.',
      'endorsements.readMore': 'Ver más',
      'endorsements.readLess': 'Ver menos',
      'endorsements.credential.btn': 'Mostrar Credencial / Comprobante',
      'endorsements.notice.text': 'Nota: Los cargos de los autores reflejan una fotografía en el momento de la recomendación en el formato (CARGO ACTUAL) | (CARGO EN EL CONTEXTO DE LA RECOMENDACIÓN). Para actualizaciones en tiempo real, consulte sus perfiles de LinkedIn.',
      ...
      'exp.about.company.btn': 'Sobre la Empresa',
      'exp.about.company.close': 'Cerrar información de la empresa',
      'exp.company_ticker.title': 'Empresas Destacadas',
      'exp.company_modal.about': 'Sobre la Empresa',
      'exp.company_modal.roles': 'Cargos y Desempeños',
      'exp.company_modal.view': 'Ver Detalles',
      'exp.company_modal.close': 'Cerrar modal',
      'edu.provider_ticker.title': 'Proveedores de Cursos',
      'edu.provider_modal.credentials': 'Enlaces de Credencial',
      'edu.provider_modal.all_courses': 'Todos los cursos de este proveedor',
      'edu.provider_modal.close': 'Cerrar modal',
      'btn.expand': 'Expandir',
      'btn.minimize': 'Minimizar',
      'exp.card.expand': 'Ver detalles',
      'exp.card.collapse': 'Minimizar detalles',
      ...
      'blog.overline': 'Escritura',
      'blog.title': 'Blog',
      'blog.read.btn': 'Leer',
      'blog.close.btn': 'Cerrar artículo',
      'blog.published': 'Publicado el',
      'blog.share.btn': 'Copiar enlace',
