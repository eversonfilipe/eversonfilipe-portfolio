...
(function I18n() {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      'hero.overline': 'Junior Implementation Engineer · Aspiring AI Engineer',
      'hero.title': 'Technical Implementation · Integrations · Data Integrity',
      'hero.tagline': 'Bridging the gap between business requirements and scalable software execution through rigorous data validation and process automation.',
    ...
    pt: {
      ...
      'hero.overline': 'Engenheiro de Implantação Júnior · Aspirante a AI Engineer',
      'hero.title': 'Implantacao Tecnica · Integracoes · Integridade de Dados',
      'hero.tagline': 'Unindo requisitos de negocio a execucao escalavel de software por meio de validacao de dados e automacao de processos.',
    ...
    es: {
      ...
      'social.email': 'Correo de contacto',
      'hero.overline': 'Ingeniero de Implementación Junior · Aspirante a AI Engineer',
      'hero.title': 'Implementacion Tecnica · Integraciones · Integridad de Datos',
      'hero.tagline': 'Conectando requisitos de negocio con ejecucion escalable de software a traves de validacion rigurosa de datos y automatizacion de procesos.',
      'hero.cta.work': 'Ver experiencia',
